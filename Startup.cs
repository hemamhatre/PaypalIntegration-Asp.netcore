...
namespace ChatValues.Web
{
	public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ChatValuesContext>(options => options.UseSqlServer(connection));
			services.AddSingleton<ITemplateManager, EmailTemplateManager>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                AuthenticationScheme = "ChatValuesCookieMiddlewareInstance",
